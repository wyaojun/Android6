...
import com.example.demo_pyq.adapter.MyRecycleViewAdapter;
import com.example.demo_pyq.bean.GridImageModle;
...
public class MainActivity extends AppCompatActivity {
    ...
    class LoadTask extends AsyncTask<Void, Void, GridImageModle> {
        ...
        protected GridImageModle doInBackground(Void... voids) {
            Gson gson = new Gson();
            GridImageModle imageModle = gson.fromJson(getData(), GridImageModle.class);
            return imageModle;
        }

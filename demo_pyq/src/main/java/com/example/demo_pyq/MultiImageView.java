...
public class MultiImageView extends LinearLayout {
     ...
     * 长度 单位为Pixel
     **/
    private int pxOneWidth = DensityUtils.dip2px(getContext(), 200); // 单张图时候的宽
    private int pxOneHeight = DensityUtils.dip2px(getContext(), 150); // 单张图时候的高
    private int pxMoreWandH = 0; // 多张图的宽高
    private int pxImagePadding = DensityUtils.dip2px(getContext(), 2);// 图片间的间距
